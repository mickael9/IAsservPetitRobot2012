...
//#include "../ProcTelemetres/ProcTelemetres.h"
...
int main() {
  ...
  ttt.attach(commandManager, &CommandManager::setEmergencyStop, 85);
...
// On rafraichit l'asservissement r&#65533;guli&#65533;rement
void Live_isr() {   
  odometrie->refresh();
  consignController->perform();
  //commandManager->perform();
  if(commandManager->perform()) ia->popCommand();
  //pc.printf("alive!\n");
  liveLed = 1 - liveLed;
  #ifdef DEBUG
    temps++;
